            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "StatusOK",
                        "schema": {
                            "$ref": "#/definitions/v1.ClientLicResp"
                        }
                    },
                    "400": {
                        "description": "StatusBadRequest",
    ...
    "definitions": {
        ...
        "v1.CAStatusResp": {
            ...
            "properties": {
                ...
                "disable": {
                    "description": "is ca disabled, by soft start/stop ca, if disabled, ca can't supply nomal service",
                    "type": "boolean",
                    "example": false
                },
                "dongle_id": {
                ...
                "status": {
                    "description": "ca status, \"alone\" or \"alive\" or \"dead\", means whether ca is in alive",
                    "type": "string",
                    "example": "alone"
                }
            }
